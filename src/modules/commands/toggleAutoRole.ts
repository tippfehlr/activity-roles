				...
				embeds: [
					new EmbedBuilder()
						.setTitle(
							__(
								{
									phrase: 'Automatic role assignment for your user is now **%s**.',
									locale,
								},
								autorole
									? __({ phrase: 'enabled', locale })
						...
						.setDescription(
							__({
								phrase: 'You can change this with the command `/toggleAutoRole`.',
								locale,
							}),
						)
