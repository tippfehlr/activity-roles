      ...
      embeds: [
        new EmbedBuilder()
          ...
          .setFooter({
            ...
            text:
              config.author === config.host
                ? __({ phrase: 'Made and hosted by %s', locale }, config.author)
                : __({ phrase: 'Made by %s and hosted by %s', locale }, config.author, config.host),
          ...
          .addFields({
            ...
            value: __(
              ...
              '@EianLee#7234, @Krampus#2007 **[Brasilian Portuguese]**, @RstY_CZ#2033 **[Czech]**, @dangerBEclose#1654 **[Dutch]**, @skyykc#0218, @Mann#9999, Hugo Moreira#4306, Tillmann Taute **[German]**'
            )
          }),
        commandEmbed
      ]
